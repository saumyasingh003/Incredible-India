...
const Home = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      <div style={{ height: '65vh', width: '100vw', position: 'relative',top:'1.2rem', overflowX: 'hidden' }}>
        <video
      ...
      <div className="relative text-center z-20 bottom-[20rem]">
        <h1  data-aos="zoom-out-left" style={{ fontFamily: " 'Bricolage Grotesque', sans-serif" }} className=" text-6xl first-letter: text-white mb-3">
      ...
      <h1  data-aos="fade-up" className="text-center text-5xl relative bottom-16 font-extrabold text-[#CB337A] font-sans" style={{ fontFamily: "'Russo One', sans-sarif"}}>
