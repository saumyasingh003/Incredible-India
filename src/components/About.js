        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          <div>
            <h2
              ...
              className="text-3xl font-bold  text-center sm:text-5xl dark:text-gray-50"
            >
              About Us
            </h2>
            ...
            <div className=" relative top-1 align-right mb-10">
              ...
              >
                India, officially known as the Republic of India, is a diverse
                and culturally rich nation located in South Asia. With a history
                spanning thousands of years, India has made significant
                contributions to the world in various fields, including art,
                science, philosophy, and technology. From its ancient
                civilizations to its modern achievements, India's story is a
                tapestry of complexity, diversity, and innovation.
              </p>
            </div>
          </div>
          ...
          <div className="">
            <div className="mt-12 space-y-12  ">
              ...
              <div
                ...
                className="grid sm:grid-cols-2 grid-cols-1 space-x-16 sm:pl-32"
              >
                ...
                className="relative right-8 ">
                  <img
                    ...
                    alt=""
                    className=" rounded-lg shadow-lg dark:bg-gray-500 sm:h-[48vh] mt-10 w-full  sm:w-[28vw]"
                  />
                </div>
              </div>
              ...
              <div  
                ...
                className=" grid sm:grid-cols-2 grid-cols-1 space-x-16 sm:pr-32"
              >
                {/* <div className="pl-36">
                  <img
                    src={require("../assets/jatayu.jpg")}
                    alt=""
                    className=" rounded-lg shadow-lg dark:bg-gray-500 h-[48vh] w-[30vw]" 
                  />
                </div> */}
                ...
                <div className=" sm:pl-40 ">
                  <img
                    src={require("../assets/jatayu.jpg")}
                    alt=""
                    className=" rounded-lg shadow-lg dark:bg-gray-500  sm:h-[48vh] w-full sm:w-[30vw] mb-10"
                  />
                </div>
              ...
              >
                <div className="flex shadow-2xl p-6 rounded-2xl  ">
                  ...
                  <div className="ml-4 ">
                    ...
                    <p className="mt-2 text-black">
                      India's cultural diversity is unparalleled. It is home to
                      a multitude of languages, religions, and traditions.
                      Hinduism, Buddhism, Islam, Christianity, Sikhism, and
                      Jainism all originated in India, making it a spiritual and
                      religious hub. The country celebrates a variety of
                      festivals, such as Diwali (Festival of Lights), Eid,
                      Christmas, Holi (Festival of Colors), and more, reflecting
                ...
                className="relative right-8 ">
                  <img
                    src={require("../assets/culture1.jpg")}
                    alt=""
                    className=" rounded-lg shadow-lg dark:bg-gray-500 sm:h-[48vh]
                     mt-10 w-full  sm:w-[28vw]"
                  />
                </div>
              </div>
              ...
              >
                ...
                <div className=" sm:pl-36  ">
                  <img
                    src={require("../assets/Science.jpg")}
                    alt=""
                    className=" rounded-lg shadow-lg dark:bg-gray-500  sm:h-[48vh] sm:w-[28vw]   w-full  mb-10"
                  />
                </div>
                <div className="flex shadow-2xl p-6 rounded-2xl">
                  <div className="flex-shrink-0 ">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">
                      ...
                      accomplishments. The contributions of Indian scientists
                      and mathematicians have had a lasting impact on the world.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex shadow-2xl p-6 rounded-2xl  ">
                  ...
                  <div className="ml-4 ">
                    ...
                    <p className="mt-2 text-black">
                      ...
                      the world. The country is famous for its intricately
                      carved temples, majestic palaces, and stunning monuments.
                      Notable examples include the Taj Mahal, a UNESCO World
                      Heritage Site and a symbol of eternal love, and the
                      intricate temples of Khajuraho, known for their exquisite
                      sculptures..
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex shadow-2xl p-6 rounded-2xl">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-2 dark:text-gray-400">
                      In the modern era, India has achieved significant
                      milestones in various domains. The country is renowned for
                      its information technology (IT) industry, with cities like
                ...
                <div className="flex shadow-2xl p-6 rounded-2xl  ">
                  ...
                  <div className="ml-4 ">
                    ...
                    <p className="mt-2 text-black">
                      ...
                      innovation, with a burgeoning startup ecosystem that
                      covers areas from technology to social entrepreneurship.
                    </p>
                  </div>
                </div>
                <div  data-aos="fade-down-right"
